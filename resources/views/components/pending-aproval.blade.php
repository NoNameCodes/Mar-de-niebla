...
<div class="flex  flex-col items-center m-6">
        ...
        <div class="flex flex-row justify-between items-center m-2">
            ...
            <div class="flex flex-row justify-center w-30 h-20">
                <div class="flex items-center w-20 h-20">
                    <a class="flex justify-center  w-10 bg-[#92C954] rounded-full" href="{{ route('admin.users.approve', $user->id) }}">
                ...
                <div class="flex items-center w-20 h-20">
                    <a class="flex justify-center w-10 h-10 bg-[#E61818] rounded-sm pt-0.5" href="{{ route('admin.users.reject', $user->id)}}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="white">
    ...
    <div class="m-20">
        <a href="{{ route('admin.users.index') }}">
            <button id="btnAdd" class=" px-6 py-1 mx-auto block rounded-md text-md font-semibold text-white bg-[#F8981D] hover:bg-[#ffba25] duration-300 drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]">Gestionar
