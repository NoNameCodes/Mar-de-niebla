...
<div class="flex flex-col items-center m-6">
    <h1 class="text-orange-400 m-6 text-6xl">Validaciones pendientes</h1>
    <div class="h-96">
        @forelse ($users as $user)
            <div class="flex flex-row justify-between items-center m-2">
                <p class="text-left text-4xl mr-36">{{ $user->email }}</p>
                <div class="flex flex-row justify-center w-30 h-20">
                    <div class="flex items-center w-20 h-20">
                        <a class="flex justify-center  w-10 bg-green-500 rounded-full"
                    ...
                    <div class="flex items-center w-20 h-20">
                        <a class="flex justify-center w-10 h-10 bg-red-500 rounded-sm pt-0.5">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="white">
...
@empty
    ...
    @endforelse
    <button class="bg-orange-400 text-white  text-3xl rounded-lg h-40 w-96 m-5 shadow-md">Gestionar
