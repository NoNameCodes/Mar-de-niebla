<div>
    <button
        class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 focus:bg-gray-100 w-60 p-4 shadow rounded bg-white text-m font-medium leading-none text-gray-800 flex items-center justify-between cursor-pointer border border-[#F8981D]"
                ...
                <div class="flex items-center">
                    <div class="pl-4 flex items-center">
                        <div
                            ...
                            <input aria-labelledby="user1" type="checkbox" name="user_id" value={{ $user->id }}
                        ...
                        <p id="users" tabindex="0" class="focus:outline-none text-sm leading-normal ml-2 text-gray-800">
                            {{ $user->name }}</p>
                    </div>
                </div>
            </div>
