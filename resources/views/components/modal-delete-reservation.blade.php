<div id="defaultModal{{ $reserva->id }}" role="dialog" tabindex="-1" aria-hidden="true"
    ...
    <div class="modal-dialog relative p-4 w-full max-w-2xl h-full md:h-auto" role="document">

        <div class="modal-content relative rounded-lg shadow bg-gray-700 backdrop-grayscale-0">
            ...
            <div class="flex justify-center items-start p-5 rounded-t border-b border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="defaultModal{{ $reserva->id }}">
            ...
            <div class="p-6 space-y-6">
                <p class="text-base leading-relaxed text-gray-500 text-gray-400">
                    La única manera de poder volver a disponer del recurso será realizando todo el proceso de reserva de
                    nuevo.
                </p>
            </div>
            <div class="flex justify-between p-6 space-x-2 rounded-b border-t border-gray-200 border-gray-600">
                <button data-modal-toggle="defaultModal{{ $reserva->id }}" type="button"
                    ...
                    type="button" onclick="location.href = '{{ route('reserva.destroy', $reserva->id) }}'">Sí,
                    anular</button>
                <button data-modal-toggle="defaultModal{{ $reserva->id }}" type="button"
