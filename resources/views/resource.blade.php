   ...
   <div class="flex w-3/4">
      <div class="flex flex-col">
           ...
           <div class="flex flex-col justify-center p-2 mt-10">
               <button class="btn  inline-block select-none no-underline align-middle  cursor-pointer whitespace-nowrap px-4 py-1.5 rounded text-base mt-6 font-medium leading-6 tracking-tight text-white text-center border-0 bg-[#92C954] hover:bg-[#85f307] duration-300" type="button">Reservar</button>
           </div>
         </div>       
      </div>
</div> 
