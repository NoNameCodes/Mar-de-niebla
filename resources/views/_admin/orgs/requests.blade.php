@extends('layouts.app', ['title' => 'Solicitudes de Registro | Barrio Oeste'])
@section('main')
                ...
                @forelse ($users as $user)
                    <div class="flex w-11/12 flex-row items-center justify-between mx-2 p-2">
                        ...
                        <div class="flex flex-row ml-5">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 m-2 " viewBox="0 0 20 20" fill="green">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 m-2" viewBox="0 0 20 20" fill="red">
